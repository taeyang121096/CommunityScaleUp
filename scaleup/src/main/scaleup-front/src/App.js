...
import BulletinBoard03 from './pages/community/BulletinBoard03';
import BulletinBoard04 from './pages/community/BulletinBoard04';
...
function App() {
  return (
    ...
    <Routes>
                ...
                <Route path="/communitymain" element = {<CoummunityMain/>}/>
